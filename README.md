...
- **Authentication Gate & Session Security**:
  ...
  - **3-Step Secure Password Recovery**: Zero-leak OTP delivery via WhatsApp or official Resend Email API (`otp@game.69club1.site`), dedicated 6-digit OTP verification screen with 60s resend cooldown, and atomic single-use OTP validation upon setting new password.
